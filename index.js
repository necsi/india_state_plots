...
function build_chart(color, dataset){
  ...
  var margin = {top: 58, right: 38, bottom: 58, left: 35},
  ...
  .key(function(d) { if(d.color == color){ return d.state;}})  // keys are country, values are the data associated w the country
  .entries(data);
...
//host = '/india_state_plots'
//host = 'https://necsi.github.io/india_state_plots'
host="";
