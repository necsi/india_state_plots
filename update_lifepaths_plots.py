...
#print(dts)
#with open("lifepaths.json","w") as fp:
#    json.dump(kk,fp)
import matplotlib.pyplot as plt
import numpy as np
...
for item1 in sts:
    ...
    for nn in pivot_cases[item1].diff().fillna(0).to_list():
        ...
        ind1+=1    
    #print(rr,ll)    
    #plt.plot(rr,ll, linestyle = 'dotted')
    #pivot_cases[item1].diff().plot()  
    #plt.title(item1)
    #plt.show()

#"series": [[[0, 27, 0, "China", 1577854800.0]]]
